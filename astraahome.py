...
def discserver():
    print(f"""{y}------------------------------------------------------------------------------------------------------------------------\n{w}adev {b}|{w} https://discord.gg/kfc {b}|{w} https://discord.gg/kfc {b}|{w} https://discord.gg/kfc {b}|{w} https://discord.gg/kfc {b}|{w} https\n{y}------------------------------------------------------------------------------------------------------------------------\n""")
...
\n          {y}[{w}04{y}]{w} Server Nuker           {y}[{w}09{y}]{w} Gif             {y}[{w}13{y}]{w} Settings Cycler
...
\n\t\t\t\t\t\t\t\t\t\t\t\t\t {y}[{b}>{y}]{w} Next Page""")
    ...
    if choice == '1' or choice == '01':
        ...
        transition()
        subprocess.call([r'Additional_File\\7_ImageGrabber\\anonix.exe'])
